...
// CS 559 FINAL PROJECT by bob wagner
...
Fl_Double_Window* GraphicsTownUI::make_window() {
  { window = new Fl_Double_Window(931, 616, "CS 559 FINAL PROJECT by bob wagner");
    window->labelsize(12);
    ...
    { Fl_Group* o = new Fl_Group(770, 5, 155, 600);
      ...
      { lgTex = new Fl_Button(775, 580, 150, 25, "WIREFRAME Mode");
        lgTex->type(1);
